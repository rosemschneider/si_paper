...
#there are two participants with incorrect coding, let's filter those values
data_exp1 %<>%
  filter(!(Subj_ID == "101314_04" & item == "frogs"))%>%
  filter(!(Subj_ID == "110714_01" & item == "books"))
``` 
...
#filter out incorrectly coded trials
data_exp2 %<>%
