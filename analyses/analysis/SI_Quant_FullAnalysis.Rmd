...
##note that you have to filter out 101314_04 none because they only have 1 none trial
dip_df_exp1 %<>%
  filter(!is.na(control_none_scalar))
...
data_exp2 %<>%
  mutate(selectionType = ifelse(Subj_ID == "120514_07" & item == "purses", "All", selectionType), 
         ifelse(Subj_ID == "120514_07" & item == "horses", "All", selectionType), 
         ifelse(Subj_ID == "120514_07" & item == "plates", "All", selectionType), 
         ifelse(Subj_ID == "120514_07" & item == "bananas", "All", selectionType))
```
