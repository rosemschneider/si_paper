...
data_exp2 %<>%
  mutate(selectionType = ifelse(Subj_ID == "120514_07" & item == "purses", 3, selectionType), 
         ifelse(Subj_ID == "120514_07" & item == "horses", 1, selectionType), 
         ifelse(Subj_ID == "120514_07" & item == "plates", 1, selectionType), 
         ifelse(Subj_ID == "120514_07" & item == "bananas", 2, selectionType))

data_exp2 %<>%
  mutate(selectionType = as.factor(selectionType))

#TO-DO - fill in "none" "some" "all" info for incorrect selection graph
```
