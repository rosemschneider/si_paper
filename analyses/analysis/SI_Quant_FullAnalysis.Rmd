...
t.test(subset(data_dccs, agegroup=="3-3.5 years" & switch_type=="Post-switch")$DCCS_correct, mu=0.5)
t.test(subset(data_dccs, agegroup=="3.5-4 years" & switch_type=="Post-switch")$DCCS_correct, mu=0.5)
t.test(subset(data_dccs, agegroup=="4-4.5 years" & switch_type=="Post-switch")$DCCS_correct, mu=0.5)
t.test(subset(data_dccs, agegroup=="4.5-5 years" & switch_type=="Post-switch")$DCCS_correct, mu=0.5)
```
