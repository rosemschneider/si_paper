...
\subsubsection{Procedure}
The procedure for our implicature task was identical to Experiment 2, the scalar-only version of the task. We drew our protocol for DCCS directly from the original methods paper \cite{zelazo2006}. 

%detailed DCCS methods here

In running the Give-Quantifier task, we followed the methods of the original task fairly closely, with the exception of a few minor modifications. 
